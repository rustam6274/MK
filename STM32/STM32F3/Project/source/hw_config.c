...
void Set_System(void)
{
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0; // Настраиваемый пин
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN; // Режим работы порта
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz; // Частота работы порта 2 10 50
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
